...
public class MigrationTask {
	    ...
	    public static void main(String[] args) throws InterruptedException  {
	    	...
	    	KBBillingImpl cartwheelKB = new KBBillingImpl(Constants.KB_CARTWHEEL_KEY, Constants.KB_CARTWHEEL_SECRET) ;
	    	 ...
	    	 KBBillingImpl bluevaultKB = new KBBillingImpl(Constants.KB_BLUVAULT_KEY, Constants.KB_BLUVAULT_SECRET) ;
