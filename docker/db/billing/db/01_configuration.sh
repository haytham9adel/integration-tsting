...
psql -v ON_ERROR_STOP=1 --username killbill --dbname killbill -f /ddl/02_killbill_ddl.sql
...
psql -v ON_ERROR_STOP=1 --username killbill --dbname killbill_plugins -f /ddl/03_kb_plugins_ddl.sql
